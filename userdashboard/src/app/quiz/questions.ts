export const QUESTIONS = [
    ...
    {
      id: 3,
      question: "How much of your income do you plan to invest?",
      options: [
        { text: "Above 50%", score: 3 },
        { text: "30%-50%", score: 5 },
        { text: "10%-30%", score: 7 },
        { text: "Below 10%", score: 10 }
      ]
    },
    {
      id: 4,
      ...
      options: [
        { text: "Long-term growth", score: 10 },
        { text: "Moderate returns", score: 7 },
        { text: "Short-term gains", score: 5 },
    ...
    // },
    {
      ...
      options: [
        ...
        { text: "Less than 2 years", score: 3 }
      ]
    },
    {
      id: 8,
      question: "How would you react to a 20% loss in your portfolio value?",
      options: [
        { text: "Stay calm and wait it out", score: 10 },
        { text: "Re-evaluate and hold", score: 7 },
        { text: "Consider selling some stocks", score: 5 },
    ...
    // },
    {
      ...
      options: [
        { text: "Expert", score: 10 },
        { text: "Intermediate", score: 7 },
    ...
    // },
    {
      ...
      options: [
        { text: "High tolerance (can accept large fluctuations)", score: 10 },
        { text: "Moderate tolerance (can accept some fluctuations)", score: 7 },
        { text: "Low tolerance (prefer stability)", score: 5 },
        { text: "No tolerance (want guaranteed returns)", score: 3 }
      ]
    }
  ];
